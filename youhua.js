...
$("#client-tab #client-mobile").removeClass("selected");
 ...
 //编辑器添加优化按钮	
 $(".form-default[name=editform]").before('<div class="yy_yh1124"><div class="yy_btn yy_btn01">优化链接</div><div class="yy_btn yy_btn02">去10px</div><div class="yy_btn yy_btn03">一键居中</div><div class="yy_btn yy_btn05">上下间距</div></div>');
 $(".form-default[name=customSetForm]").before('<div class="yy_yh1124"><div class="yy_btn yy_btn01">优化链接</div></div>');
 $(".auto-rec-form.form-default").before('<div style="margin-top:400px;" class="yy_yh1124"><div class="yy_btn yy_btn01">优化链接</div></div>');
 //优化链接
